...
Validates:
 - Persona governance integrity (via verify_persona_integrity)
 - Inference endpoint reachability
 - Redis connectivity (Phase 11-D RedisClient)
 - Prometheus /metrics health

Outputs JSON summary to /tmp/phase11f_runtime_report.json
"""
...
if os.path.exists(env_path):
    ...
    print(f"[⚠] No .env file found in {ROOT_DIR}")
