"""
streaming_server.py — Phase 6 Ready (Flattened Structure)
Handles streaming endpoints and Redis health checks for Sara AI Core.
"""
...
from logging_utils import log_event     # ✅ fixed import (was sara_ai.logging_utils)
...
def handle_stream():
    """Handles incoming stream task requests."""
